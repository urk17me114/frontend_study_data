...
\begin{itemize}
    ...
    \item \textbf{Pillow}:  
    Used in modules that handle file uploads, such as \texttt{teacher\_registration}. It provides image processing capabilities, including resizing and saving uploaded files.
    ...
    \begin{itemize}
        ...
        \item \texttt{json} – parsing and formatting JSON payloads (e.g., in \texttt{vote\_announcement}).
