...
from login.view.student_application import student_application_view
from login.view.student_approval import student_approval, approve_student, reject_student
from login.view.teacher_approval import teacher_approval, approve_teacher, reject_teacher
from login.view.student_profile import student_profile
from login.view.teacher_profile import teacher_profile, download_teacher_document
from login.view.pinboard_admin import create_pinboard, pinboard_list_admin
from login.view.pinboard_teacher import pinboard_list_teacher
from login.view.pinboard_student import pinboard_list_student
from login.view.pinboard_comment import pinboard_detail
from login.view.admin_profile import admin_profile
from django.urls import path
from . import views
...
urlpatterns=[
    ...
    path("studentapplication",student_application_view, name="studentapplication"),
    path('student_approval/', student_approval, name='student_approval'),
    path('student-approval/', student_approval, name='student_approval'),
    path('approve-student/<int:student_id>/', approve_student, name='approve_student'),
    path('reject-student/<int:student_id>/', reject_student, name='reject_student'),
    path('teacher-approval/', teacher_approval, name='teacher_approval'),
    ...
    path('login/teacher/download_document/', download_teacher_document, name='download_teacher_document'),
    ...
    path('admin/pinboard/create/', create_pinboard, name='create_pinboard'),
    path('admin/pinboard', pinboard_list_admin, name='pinboard_list_admin'),
    path('teacher/pinboard/', pinboard_list_teacher, name='pinboard_list_teacher'),
    path('student/pinboard/', pinboard_list_student, name='pinboard_list_student'),
    path('pinboard/<int:pk>/', pinboard_detail, name='pinboard_detail'),
]
