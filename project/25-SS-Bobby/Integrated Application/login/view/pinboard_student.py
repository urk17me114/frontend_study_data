...
Functionality:
    - Student can view the pinboard list (read-only).
...
def pinboard_list_student(request):
    """
    Student view: list of pinboard announcements (paginated).
    """
    return pinboard_list_common(request, 'Student')