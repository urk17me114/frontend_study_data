"""
=============================================================
Django Role-Based Dashboard Views with Session Validation
=============================================================
...
Functionality:
    Provides dashboards for Admin, Teacher, and Student roles.
    Each dashboard displays role-specific functionalities.
...
def admin_dashboard(request):
    functionalities = [
        ...
        {'label': 'Pinboard', 'url_name': 'pinboard_list_admin'},
        {'label': 'Create Pinboard', 'url_name': 'create_pinboard'},
    ]
...
def teacher_dashboard(request):
    functionalities = [
        ...
        {'label': 'Pinboard', 'url_name': 'pinboard_list_teacher'},
    ]
...
def student_dashboard(request):
    functionalities = [
        ...
        {'label': 'Pinboard', 'url_name': 'pinboard_list_student'},
    ]
